...
const initialData = {
  ...
  layers: [
    ...
    { material: "Solder Mask", thk: 2, color: "#2d5a27" }
  ],
  children: []
};
...
export default function App() {
  ...
  return (
    <div style={{ display: 'flex', width: '100vw', height: '100vh', background: '#0a0a0a', color: '#eee', fontFamily: 'monospace' }}>
      ...
      {/* LEFT SIDEBAR: Tree + Original Edit Controls */}
      <div style={{ width: '400px', padding: '15px', borderRight: '1px solid #333', overflowY: 'auto', background: '#111' }}>
        ...
        <TreeItem 
          ...
          onAdd={(pid) => updateNodeRecursive(pid, n => ({...n, children: [...n.children, { id: Math.random().toString(36).substr(2,6), name: "New Die", z: 12, visible: true, opacity: 1.0, showBottom: true, face: { type: "BOX", dim: [0, 0, 20, 20] }, layers: [{material:"Si", thk:5, color:"#369"}], children: [] }]}))}
      ...
      <div style={{ width: '250px', padding: '15px', borderLeft: '1px solid #333', background: '#111' }}>
        ...
        {/* GRIND BLOCK: Styled with green color scheme */}
...
// --- UI ITEM COMPONENT (Keeps existing logic on Left) ---
